...
const MESSAGE = `
Happy Valentine day วันแห่งความรัก 
ขอบคุณที่เข้ามาเป็นครึ่งของกันและกันมอบสิ่งที่ดีให้กันตลอด ขอบคุณที่ดูแลน้องดีมาตลอด ขอบคุณสำหรับทุกๆอย่างที่มอบให้กันนะ รักเธอมากๆเลยนะอยู่กับน้องไปจนแก่เลยนะเธอ
`;
